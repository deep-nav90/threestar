         ...
         <div class="navbar_bar">
            <nav aria-label="breadcrumb">
               <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item remove_hover">Add Question Answer</li>
              ...
              <div style="margin-bottom: 18px;">
                ...
                <span class="text-danger error video_err">{{$errors->first('video_url')}}</span>  
                        ...
                        <div class="form-group selectdiv pb-3">
                           <select class="form-control" name="defensive_situation_id" id="defensive_situation_id" class="form-control">
                              @foreach($defense_situations as $defense_situation )
                                 <option value="{{$defense_situation->id}}">{{$defense_situation->situation_name}}</option>
                              @endforeach
                           </select>
                  ...
                  <div class="add_content">
                     ...
                     <div class="form-group pb-3">
                        <input type="text" class="form-control" id="you_are" name="you_are" placeholder="Enter You Are" />
                  ...
                  <div class="add_content">
                     ...
                     <div class="form-group pb-3">
                     <input type="text" class="form-control" id="runners_on" name="runners_on" placeholder="Enter Runners On" />
                  ...
                  <div class="add_content">
                     ...
                     <div class="form-group pb-3">
                        <input type="text" class="form-control" id="out" name="out" placeholder="Enter Outs" />
                        @if($errors->first('out'))
                  ...
                  <div class="add_content">
                     ...
                     <div class="form-group pb-3">
                        <textarea rows="5" cols="87" id="also_think_about_it" name="also_think_about_it" placeholder="Enter Also Think About It"></textarea>
                  ...
                  <div class="add_content">
                     ...
                     <div class="form-group pb-3">
                        <div class="row">
                            <div class="col-md-11">
                                    <input type="text" class="form-control answer_req" name="answer[0]" placeholder="Enter Answer" />
                            ...
                            <div class="col-md-1 mt-3">
                                ...
                                <label class="checkout">
                                    <input type="checkbox" class="checkmarks" name="is_correct" value="0">
                  ...
                  <div class="add_content">
                     ...
                     <div class="form-group pb-3">
                        <div class="row">
                           <div class="col-md-11">
                              <input type="text" class="form-control answer_req" name="answer[1]" placeholder="Enter Answer" />
                              @if($errors->first('answer_two'))
                              <span class="text-danger error">{{$errors->first('answer_two')}}</span>
                              @endif()
                           </div>
                           <div class="col-md-1 mt-3">
                              <label class="checkout">
                                    <input type="checkbox" class="checkmarks" name="is_correct" value="1">
                                          <span class="checkmark"></span>
                              </label>   
                  ...
                  <div class="add_content">
                     ...
                     <div class="form-group pb-3">
                        <div class="row">
                           <div class="col-md-11">
                              <input type="text" class="form-control answer_req" name="answer[2]" placeholder="Enter Answer" />
                              @if($errors->first('answer_three'))
                              <span class="text-danger error">{{$errors->first('answer_three')}}</span>
                              @endif()
                           </div>
                           <div class="col-md-1 mt-3">
                              <label class="checkout">
                                 <input type="checkbox" class="checkmarks" name="is_correct" value="2">
                                    <span class="checkmark"></span>
                              </label>    
                  ...
                  <div class="add_content">
                     ...
                     <div class="form-group pb-3">
                        <div class="row">
                           <div class="col-md-11">
                              <input type="text" class="form-control answer_req" name="answer[3]" placeholder="Enter Answer" />
                              @if($errors->first('answer_four'))
                              <span class="text-danger error">{{$errors->first('answer_four')}}</span>
                              @endif()
                           </div>
                           <div class="col-md-1 mt-3">
                              <label class="checkout">
                                 <input type="checkbox" class="checkmarks" name="is_correct" value="3">
                                    <span class="checkmark"></span>  
                              </label> 
                  ...
                  <div class="upload_align">
                    <div class="user_img mr-2" title="Upload Image" style="
                      position: relative;">
                      <img class="click_upload img_upload" id="image_up" src="{{url('public/admin/assets/img/dum5_l.jpg')}}" alt="woman">
                    </div>
                  </div>
                  ...
                  <div class="add_content">
                     ...
                     <div class="form-group pb-3">
                        <textarea rows="5" cols="87" id="situation_description" name="situation_description"></textarea>
                     </div>
                  </div>
            ...
            question : {
               ...
               out :{
                required : "Please enter outs.",
                  maxlength:"Out should be less than 50 characters."
               },
               also_think_about_it:{
