					...
					<div class="navbar_bar">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item remove_hover">Edit Reward</li>
					...
					<div class="card">
						<div class="card-body add_imgae_box">
                            ...
                            <div class="user_img mr-2" title="Upload Image" style="
                                ...
                                @if(count($findReward->rewardImages) > 0)
                                    @foreach($findReward->rewardImages as $rewardImage)

                                        <div class="user_img mr-2" ui="image" title="Upload Image" style="position: relative; margin-bottom: 16px;">
                                        <img class="click_upload img_upload" src="{{$rewardImage->image}}" alt="woman">
                                        
                                            <div class="add_img cross_icon">
                                                <img class="click_upload plus_icon cross_icon_old" del_id = "{{$rewardImage->id}}" ui="image" src="{{url('public/admin/assets/img/cross.png')}}" alt="cross">
                                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group pb-3">
                                        <input type="text" class="form-control" placeholder="Enter Reward Name" value="{{$findReward->reward_name}}" name="reward_name" />
