...
@section('title','Add Challenge/Badge')
@section('content')
					...
					<div class="navbar_bar">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item remove_hover">Add Challenge/Badge</li>
								<!-- <li class="breadcrumb-item active" aria-current="page">Data</li> -->
							</ol>
						</nav>
					</div>
					<h1>Add Challenge/Badge</h1>
					<div class="card">
						<div class="card-body add_imgae_box">
							<form method="POST" id="validate_form" enctype="multipart/form-data">
								{{@csrf_field()}}

							<div class="user_img" title="Upload Image" style="width: 12%;
							margin: auto; position: relative;">
								<img id="upload_image_view" class="click_upload" src="{{url('public/admin/assets/img/dum_l.jpg')}}" alt="woman">
								<div class="add_img">
							...
							<div class="add_content">
									...
									<div class="mb-3">
										<input type="text" class="form-control" name="challenge_name" placeholder="Enter Challenge Name">
            ...
            /*  console.log(file);*/
              if (file) {
               ...
               if(file.type == "image/jpeg" || file.type == "image/jpg" || file.type == "image/png"){
                ...
                if(size > 52428800){
                    $("#image_error").text("Image should not be greater than 5 MB.").show();
