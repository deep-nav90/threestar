					...
					<div class="navbar_bar">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item remove_hover">Edit Buzz Feed</li>
								<!-- <li class="breadcrumb-item active" aria-current="page">Data</li> -->
							</ol>
						</nav>
					</div>
					<h1>Edit Buzz Feed</h1>
					<div class="card">
						<div class="card-body add_imgae_box">
							...
							<div>
								...
								<input type="hidden" name="video_count" value="{{$video_count}}" id="video_count">
								<input type="hidden" name="audio_count" value="{{$audio_count}}" id="audio_count">
							...
							<div class="upload_align">
								...
								@foreach($buzz_feed_find->buzzFeedFiles as $buzz_feed_file)
									...
									<img class="click_upload img_upload" src="{{$buzz_feed_file->file_url}}" alt="woman">
									
									<div class="add_img cross_icon">
										<img class="click_upload plus_icon cross_icon_old" del_id = "{{$buzz_feed_file->id}}" ui="image" src="{{url('public/admin/assets/img/cross.png')}}" alt="cross">
									</div>
									...
									position: relative; margin-bottom: 16px;">
										<div style="margin-bottom: 18px;">
											<video width="320" height="240" controls class="video_setup video_upload" src="{{$buzz_feed_file->file_url}}">
											 ...
											 <div class="add_img cross_icon">
												<img class="click_upload plus_icon cross_icon_old" del_id = "{{$buzz_feed_file->id}}" ui="video" src="{{url('public/admin/assets/img/cross.png')}}" alt="cross">
											</div>
										</div>
									</div>
									@else
									...
									<div style="margin-bottom: 18px; border: 2px solid #daa905; border-radius: 7px; width: 180px;">
										...
										<audio controls class="audio_width" src="{{$buzz_feed_file->file_url}}">
										 ...
										 <div class="add_img cross_icon">
										<img class="click_upload plus_icon cross_icon_old" ui="audio" del_id = "{{$buzz_feed_file->id}}"  src="{{url('public/admin/assets/img/cross.png')}}" alt="cross" style="margin-left: 73px;">
										</div>
									</div>
							...
							<div class="add_content">
									...
									<div class="form-group pb-3">
										<input type="text" class="form-control" name="title" value="{{$buzz_feed_find->title}}" placeholder="Enter Title"/>
									</div>
							...
							<div class="add_content">
									...
									<div class="form-group pb-3">
										...
										<textarea class="form-control" name="description" placeholder="Enter Description">{{$buzz_feed_find->description}}</textarea>
									</div>
 ...
 <div class="text-center" style="width: 100%;">       
  <h4 class="modal-title" style="font-size: 18px; color: #fff;">Alert</h4>
      ...
      <div class="modal-body">
      	<div class="text-center">
        <p style="font-size: 18px; color: #575962;" id="alert_message"></p>
    </div>
      </div>
	...
	$(document).ready(function(){
		...
		$(".cross_icon_old").on("click",function(){
			...
			if(type == "image"){
				...
				parent_find_div = $(this).parent().parent().parent();

				let video_count = $("#video_count").val();

				let sub_1 = video_count - 1;

				$("#video_count").val(sub_1);
				...
				let sub_1 = audio_count - 1;

				$("#audio_count").val(sub_1);
