					...
					<div class="navbar_bar">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('admin.usersViewWalletDetails',$encodeUserID)}}">Users Wallet Details</a></li>
								<li class="breadcrumb-item remove_hover">View Claim Detail</li>
