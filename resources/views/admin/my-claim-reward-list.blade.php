...
@section('title','Claim Reward Management')
@section('content')
					...
					<div class="navbar_bar">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item remove_hover">My Claim Reward Management</li>
								<!-- <li class="breadcrumb-item active" aria-current="page">Data</li> -->
							</ol>
						</nav>
						@include('admin.layout.notification')
					</div>
					<h1>Claim Reward Management</h1>
					<div class="card">
						<div class="card-body">
...
function dataTableHit(dataGET){
      ...
      $('#rewardList').dataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "{{ route('admin.myClaimRewardManagement') }}",
                "type": "POST",
                "data" : dataGET,
              complete:function(){
